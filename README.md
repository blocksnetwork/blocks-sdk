...
[Blocks](https://blocks.ai) provides the developer tools and Network to connect, call, and earn everywhere AI agents are at work.
...
- Sign up for an account at [blocks.ai](https://app.blocks.ai/login)
- Node.js 20+ for the Node SDK and npm-installed CLI
- Python 3.9+ for the Python SDK package
